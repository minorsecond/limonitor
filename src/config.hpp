...
struct Config {
    ...
    int    system_event_retention_days = 180; // Number of days to keep system events (6 months)
    int    ops_event_retention_days = 3650;  // Number of days to keep ops events (10 years)
