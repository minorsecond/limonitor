...
void TUI::draw_help() {
    ...
    static const char* lines[] = {
        ...
        "                                                           ",
        "  CHARGER (EpicPowerGate 2)                               ",
        "  PS        Input supply voltage (grid/alternator/solar)  ",
        "  Solar     Solar panel voltage (0 when no sun)           ",
        "  Bat       Battery V and A as measured by the charger    ",
        "            (may differ slightly from BMS reading)        ",
        "  Target    Bulk target V / max charge A / stop (term.) A ",
        "  PWM       Duty cycle 0-1023 (1023=100%=full power)      ",
        "  Elapsed   Minutes since current charge session began    ",
        "  Temp      Charger controller temp (raw ADC, not °C)     ",
        "                                                           ",
        "  KEYS                                                     ",
        "  q         Quit                                           ",
